...
if __name__ == "__main__":
      ...
      match_features.main(match_features.confs['superglue'], pairs = Path(args.pairs), features= Path(args.feature), features_ref= Path(args.features_ref), matches= Path(args.output_path))