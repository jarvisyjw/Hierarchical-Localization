...
echo "Matching features for day sequence.."
python gvbench_utils.py --matching_loftr --pairs datasets/GV-Bench/release/gt/day.txt --image_path datasets/GV-Bench/release/images --features datasets/GV-Bench/release/features --output_path datasets/GV-Bench/release/matches

echo "Matching features for night sequence.."
python gvbench_utils.py --matching_loftr --pairs datasets/GV-Bench/release/gt/night.txt --image_path datasets/GV-Bench/release/images --features datasets/GV-Bench/release/features --output_path datasets/GV-Bench/release/matches

echo "Matching features for season sequence.."
python gvbench_utils.py --matching_loftr --pairs datasets/GV-Bench/release/gt/season.txt --image_path datasets/GV-Bench/release/images --features datasets/GV-Bench/release/features --output_path datasets/GV-Bench/release/matches

echo "Matching features for weather sequence.."
python gvbench_utils.py --matching_loftr --pairs datasets/GV-Bench/release/gt/weather.txt --image_path datasets/GV-Bench/release/images --features datasets/GV-Bench/release/features --output_path datasets/GV-Bench/release/matches